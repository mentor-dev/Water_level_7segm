...
// Для работы в Proteus раскомментировать выделенный участок (датчик будет делать замеры не по WDT, а по таймеру)  (строка 110)
...
// 148 и 358 строки закомментировал для отключения кнопки (смены режимов) во избежание 
